export const features = [
  {
    ...
    text: "CurioHost offers clear and competitive pricing designed for developers, creators, and hosting providers of all sizes. ",
    button: {
  ...
  },
  {
    ...
    text: "We prioritize your data's safety with advanced encryption and reliable uptime — hosting you can count on.",
    button: {
...
export const details = [
  {
    ...
    title: "AI automated control panel",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Free Tier Forever For Everyone",
  },
  {
    id: "2",
...
export const plans = [
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Exclusively for Server Owners",
    features: [
      "16GB Ram",
      "Unlimited Storage",
      "5 Servers",
